...
@AndroidEntryPoint
class GreetingNoteFragment : Fragment() {

    private lateinit var binding: FragmentGreetinNoteBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentGreetinNoteBinding.inflate(inflater, container, false)
